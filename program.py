...
class App:
    def __init__(self):
        ...
        self.main_window.geometry("1100x520+350+50")

        self.login_button_main_window = util.get_button(
            self.main_window, 'Check Authenticity', 'green', self.login)
        self.login_button_main_window.place(x=750, y=300)

        self.register_new_user_button_main_window = util.get_button(self.main_window, 'Registeration', 'gray',
    ...
    def login(self):
        ...
        if name in ['unknown_person', 'no_persons_found']:
            util.msg_box(
                'ALERT!!!', 'Unknown. Please check the authenticity of the person.')
        else:
            util.msg_box(
    ...
    def register_new_user(self):
        ...
        self.register_new_user_window.geometry("1100x520+350+50")
        ...
        self.text_label_register_new_user = util.get_text_label(
            self.register_new_user_window, 'Please, Enter the name')
